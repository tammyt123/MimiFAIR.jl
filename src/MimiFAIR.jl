...
function get_model(;rcp_scenario::String="RCP85", start_year::Int=1765, end_year::Int=2300, F2x::Float64=3.71, TCR::Float64=1.6, ECS::Float64=2.75, d::Array{Float64,1}=[239.0, 4.1])
